        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="opacity:0.8">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="spa">SPA</a>
                    </li>
                    <li class="nav-item">
...
?>
        ...
        <!-- <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="position: fixed;">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="spa" role="tab" aria-controls="pills-contact" aria-selected="false">Spa</a>
            </li>

        </ul> -->

        <div id="jumbotronSpa" class="jumbotron jumbotron-fluid text-white d-flex justify-content-center align-items-center">
            <div class="container text-center">
                <h1 class="display-1 text-dark text-uppercase">COMBRERO HOTEL</h1>
                <p class="display-4 d-none d-sm-block text-primary">TAKE LOOK AT SPA IN OUR HOTEL</p>
                <p class="text-warning h5 mb-3">Check other images on:</p>
...
?>
            ...
            <div class="col-3 bg-warning">
                <a href="bookNew" id="book" class="rec">

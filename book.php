        ...
        <div class="container no-gutters">
            <div class="row">
                <div class="col-6 mt-5">
                    <img src="images/hotel (2).jpg" onclick="collapse1();" alt="top" style="margin-top: 25px;">
                </div>
                <div class=" offset-1 col-5 mt-5" id="collapseTop">
                    <div class="row">
                        <div class="col-12">
                            <img src="images/room.jpg" class="img-fluid" alt="room1" style="width:100px; height:100px; ">
                            <img src="images/room.jpg" class="img-fluid" alt="room1" style="width:100px; height:100px; ">
                            <img src="images/room.jpg" class="img-fluid " alt="room1" style="width:100px; height:100px; ">
                            <img src="images/room.jpg" class="img-fluid " alt="room1" style="width:100px; height:100px; ">
                        </div>
                        <div class="col-12">
                            <small style="margin-right:80px; color: white;">juhu</small>
                            <small style="margin-right: 70px; color: white;">juhu</small>
                            <small style="margin-right: 70px; color: white;">juhu</small>
                            <small style="color: white;">juhu</small>
                        </div>
                        <div class="col-12">
                            <img src="images/room.jpg" class="img-fluid" alt="room1" style="width:100px; height:100px; ">
                            <img src="images/room.jpg" class="img-fluid" alt="room1" style="width:100px; height:100px; ">
                        ...
                        <div class="col-12">
                            <small style="margin-right: 70px; color: white;">juhu</small>
                            <small style="margin-right: 70px; color: white; color: white;">juhu</small>
                            <small style="margin-right: 70px; color: white;">juhu</small>
                            <small style=" color: white;">juhu</small>
                        </div>
                    </div>

                    <!-- <img src="images/room.jpg" class="img-fluid " alt="room1" style="width:100px; height:100px; margin-top: 10px;">
                    <img src="images/room.jpg" class="img-fluid " alt="room1" style="width:100px; height:100px; margin-top: 10px;">
                    <img src="images/room.jpg" class="img-fluid " alt="room1" style="width:100px; height:100px; margin-top: 10px;">
                    <img src="images/room.jpg" class="img-fluid " alt="room1" style="width:100px; height:100px; margin-top: 10px;"> -->
                </div>
            ...
            <div class="row">
                <div class="col-6">
                    <img src="images/hotel (3).jpg" onclick="collapse2();" alt="middle">
                </div>
                <div class=" offset-1 col-5 mt-5" id="collapseMiddle">
                    <div class="row">
                        <div class="col-12">
                            <img src="images/room.jpg" class="img-fluid" alt="room1" style="width:100px; height:100px; ">
                            <img src="images/room.jpg" class="img-fluid" alt="room1" style="width:100px; height:100px; ">
            ...
            <div class="row">
                <div class="col-4">
                    <img src="images/hotel (4).jpg" onclick="collapse3();" alt="down">
                </div>
                <div class="offset-4 col-4" id="collapseDown">
                    <img src="images/hotel.jpg" alt="room1" style="width:100px; height:100px;margin-top: 25px;">
                </div>
            </div>
        </div>

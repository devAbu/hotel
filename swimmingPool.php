        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="opacity:0.8">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="swimmingPool">Swimming Pool</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div id="carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img src="images/swiming pool slideshow 1 - swimming pool.jpg" alt="slide1" class="d-block img-fluid">

                            </div>
                            <div class="carousel-item">
                                <img src="images/swiming pool slideshow 2 - swimming pool" alt="slide2" class="d-block img-fluid">

                            </div>
                            <div class="carousel-item">
                                <img src="images/swiming pool slideshow 3 - swimming pool" alt="slide3" class="d-block img-fluid">
        ...
        function check2(){
            ...
            if(email == "" || name =="" || date == ""){
              ...
              <script>
                 ...
                 $.ajax({
                     url: "./swimmingPoolData.php?task=reserve&date="+date+"&name="+name+"&email="+email,
                     success: function (data){
                 ...
                 $('#subButton').css('cursor', 'not-allowed');
                             ...
                             $("#alert").addClass('alert-danger');
						 	$("#alert").html('The email already exists');
						 	$("#alert").fadeIn(500).delay(1000).fadeOut(500);
                         }
                     },
                     error: function (data, err){

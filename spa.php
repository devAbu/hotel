...
?>
        ...
        <!-- <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="position: fixed;">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="spa.html" role="tab" aria-controls="pills-contact" aria-selected="false">Spa</a>
            </li>
    ...
    <footer class="w3-gray mt-3 ">
        <div class="row ml-3 ">
            ...
            <div class="col-3 bg-warning">
                <a href="bookNew.html" id="book" class="rec">

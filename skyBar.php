        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" style="opacity:0.8">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="skyBar.html">Sky Bar</a>
                    </li>
                    <li class="nav-item">
...
?>
        ...
        <!-- <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="position: fixed;">
            ...
            <li class="nav-item">
                <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="skyBar.html" role="tab" aria-controls="pills-contact"
        ...
        <div class="row no-gutters">
            ...
            <div class="col-6 bg-secondary ">
                <div class="row ">
                    ...
                    <div class="col-6 ">
                        <a href="restaurant.html" class="rec">
